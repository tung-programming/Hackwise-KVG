      ...
      <div className="flex-1 flex items-center justify-between px-6 gap-4">
        ...
        <div className="flex items-center gap-3 flex-1 max-w-sm">
          ...
          <form onSubmit={handleSearchSubmit} className="relative flex-1">
            ...
            <input
              ...
              className="w-full pl-9 pr-14 py-2.5 text-sm bg-card/50 dark:bg-card/50 border border-border/40 rounded-xl focus:outline-none focus:ring-2 focus:border-transparent transition-all placeholder:text-muted-foreground/50 backdrop-blur-sm"
              style={{ '--tw-ring-color': ACCENT } as React.CSSProperties}
            />
            <div className="absolute right-3 top-1/2 -translate-y-1/2 flex items-center gap-0.5 bg-card/50 dark:bg-card/50 rounded-md px-1.5 py-0.5">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="p-2.5 rounded-xl bg-card/50 dark:bg-card/50 hover:bg-card/50 dark:hover:bg-card/50 text-muted-foreground hover:text-foreground transition-all backdrop-blur-sm"
          >
            {theme === 'dark' ? <Sun className="w-4.5 h-4.5" /> : <Moon className="w-4.5 h-4.5" />}
          </button>

          {/* Mail */}
          <button className="p-2.5 rounded-xl bg-card/50 dark:bg-card/50 hover:bg-card/50 dark:hover:bg-card/50 text-muted-foreground hover:text-foreground transition-all backdrop-blur-sm">
            <Mail className="w-4.5 h-4.5" />
          </button>

          {/* Bell */}
          <button className="relative p-2.5 rounded-xl bg-card/50 dark:bg-card/50 hover:bg-card/50 dark:hover:bg-card/50 text-muted-foreground hover:text-foreground transition-all backdrop-blur-sm">
